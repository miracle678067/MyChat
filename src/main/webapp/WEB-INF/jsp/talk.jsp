...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/scroll-startstop.events.jquery.js"></script>
	<!--讨论区滚动条end-->
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/front/talk.js"></script>
	</head>
	<body>
