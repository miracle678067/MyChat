...
<head>
    ...
    <script type="application/javascript" src="${pageContext.request.contextPath}/js/back/list.js"></script>
...
<form action="${pageContext.request.contextPath}list" id="mainForm" method="post">
    ...
    <div class="right">
        ...
        <div class="rightCont">
            <p class="g_title fix">内容列表 <a class="btn03" href="${pageContext.request.contextPath}toAdd">新 增</a>&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn03"
                                                                                                    href="javascript:deleteBatch('${pageContext.request.contextPath}')">删 除</a></p>
            <table class="tab1">
                <tbody>
                <tr>
                ...
                <table class="tab2" width="100%">
                    ...
                    <c:forEach items="${messageList}" var="message" varStatus="status">
                        <tr  <c:if test="${status.index % 2 != 0}">style='background-color:#ECF6EE;'</c:if>>
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}update?id=${message.id}">修改</a>&nbsp;&nbsp;&nbsp;
                                <a href="${pageContext.request.contextPath}delete?id=${message.id}">删除</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
